...
class MakeDiffAstTest extends TestCase
{
    public function testMakeDiffAst()
    {
        ...
        $actual1 = [['diff' => 'unchanged', 'key' => 'key1', 'before' => 'value1', 'after' => 'value1'], 
                    ['diff' => 'unchanged', 'key' => 'key2', 'before' => 'value2', 'after' => 'value2']];
        print_r($actual1);
        ...
        $actual2 = [['diff' => 'changed', 'key' => 'key1', 'before' => 'value1', 'after' => 'value3'], 
                    ['diff' => 'unchanged', 'key' => 'key2', 'before' => 'value2', 'after' => 'value2']];
