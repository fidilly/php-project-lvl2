...
class MakeDiffAstTest extends TestCase
{
    public function testMakeDiffAst()
    {
        ...
        $array13 = ['key1' => ['key1' => 'value1', 'key2' => 'value2'],
                    'key2' => ['key1' => 'value1', 'key2' => 'value2'],
                    'key3' => ['key1' => 'value1', 'key3' => 'value3', 'key4' => 'value']];
        $array14 = ['key1' => ['key1' => 'value3', 'key2' => 'value2'],
                    'key2' => ['key1' => 'value1', 'key2' => 'value2'],
                    'key3' => ['key1' => 'value3', 'key2' => 'value2', 'key4' => 'value']];
        $expected7 = [['data' => 'unchanged',
                       'key' => 'key1',
                       'before' => null,
                       'after' => [['data' => 'changed',
                                    'key' => 'key1',
